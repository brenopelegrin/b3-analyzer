...
export default function Card({ children }: any, props: any) {
  ...
  return (
    <Flex className="min-w-4 min-h-4 rounded-xl py-4 px-4 border-2" background={card_bg} boxShadow="sm" borderColor={card_border} flexDirection="column">
      ...
      {children ? children : <Text>Default content</Text>}
      </Flex>
    </Flex>
  )
}